...
- Added the `snake` and `tetris` commands, which allow you to play Snake and Tetris, respectively! More games may be added in the future (they take a while to code though)!
